...
public class MainPanel extends JPanel {
	...
	private void initalizeGUI() {
		...
		final List<OperationSelector> convOp = new ArrayList<>();
		convOp.add(guiFactory
		...
		final List<OperationSelector> encOp = new ArrayList<>();
		encOp.add(guiFactory
		...
		encOp.add(guiFactory.createOperationSelector(ResourceKey.URL_ENCODE_ACTION, Operation.URL_ENCODE, controller, buttonGroup));
		encOp.add(guiFactory.createOperationSelector(ResourceKey.URL_DECODE_ACTION, Operation.URL_DECODE, controller, buttonGroup));
		encOp.add(guiFactory.createOperationSelector(ResourceKey.HTML_ENCODE_ACTION, Operation.HTML_ENCODE, controller, buttonGroup));
		encOp.add(guiFactory.createOperationSelector(ResourceKey.HTML_DECODE_ACTION, Operation.HTML_DECODE, controller, buttonGroup));
		encOp.add(guiFactory.createOperationSelector(ResourceKey.JWT_DECODE_ACTION, Operation.JWT_DECODE, controller, buttonGroup));
		encOp.forEach(radioPanel2::add);
		...
		final List<OperationSelector> hashOp = new ArrayList<>();
		hashOp.add(guiFactory.createOperationSelector(ResourceKey.SHA_256_ACTION, Operation.SHA256_HASH, controller, buttonGroup));
		hashOp.add(guiFactory.createOperationSelector(ResourceKey.SHA_384_ACTION, Operation.SHA384_HASH, controller, buttonGroup));
		hashOp.add(guiFactory.createOperationSelector(ResourceKey.SHA_512_ACTION, Operation.SHA512_HASH, controller, buttonGroup));
		hashOp.add(guiFactory.createOperationSelector(ResourceKey.SHA3_256_ACTION, Operation.SHA3_256_HASH, controller, buttonGroup));
		hashOp.add(guiFactory.createOperationSelector(ResourceKey.SHA3_384_ACTION, Operation.SHA3_384_HASH, controller, buttonGroup));
		hashOp.add(guiFactory.createOperationSelector(ResourceKey.SHA3_512_ACTION, Operation.SHA3_512_HASH, controller, buttonGroup));
		hashOp.add(guiFactory.createOperationSelector(ResourceKey.KECCAK_256_ACTION, Operation.KECCAK256_HASH, controller, buttonGroup));
		hashOp.add(guiFactory.createOperationSelector(ResourceKey.KECCAK_384_ACTION, Operation.KECCAK384_HASH, controller, buttonGroup));
		hashOp.add(guiFactory.createOperationSelector(ResourceKey.KECCAK_512_ACTION, Operation.KECCAK512_HASH, controller, buttonGroup));
		hashOp.forEach(radioPanel3::add);
		...
		final List<OperationSelector> otherOp = new ArrayList<>();
		otherOp.add(guiFactory.createOperationSelector(ResourceKey.ROT13_ACTION, Operation.ROT13, controller, buttonGroup));
		otherOp.add(guiFactory.createOperationSelector(ResourceKey.MD2_HASH_ACTION, Operation.MD2_HASH, controller, buttonGroup));
		otherOp.add(guiFactory.createOperationSelector(ResourceKey.MD4_HASH_ACTION, Operation.MD4_HASH, controller, buttonGroup));
		otherOp.add(guiFactory.createOperationSelector(ResourceKey.MD5_HASH_ACTION, Operation.MD5_HASH, controller, buttonGroup));
		otherOp.add(guiFactory.createOperationSelector(ResourceKey.CRC16_ACTION, Operation.CRC16, controller, buttonGroup));
		otherOp.add(guiFactory.createOperationSelector(ResourceKey.CRC32_ACTION, Operation.CRC32, controller, buttonGroup));
		otherOp.add(guiFactory
				.createOperationSelector(ResourceKey.LUHN_DIGIT_GEN_ACTION, Operation.LUHN_DIGIT_GENERATOR, controller, buttonGroup));
		otherOp.forEach(radioPanel4::add);
		...
		operations.addAll(convOp);
		operations.addAll(encOp);
		operations.addAll(hashOp);
		operations.addAll(otherOp);
